...
function _chart(partition,data,d3,width,color,arc,format,radius)
{
  ...
  path.append("title")
      .text(d => `Weight in lbs: ${format(d.value)}`);
...
FileAttachment("final@2.json").json()
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["final@2.json", {url: new URL("./files/c618dff6d92f8a7f7cb6c1f79abfccbc3de8438d507114f2f66a1a738f3e93b02a1efd4737f9954dec73dc7c08ebbbc0b02f120b0e73e1aa93130dc5f753b7f3.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
